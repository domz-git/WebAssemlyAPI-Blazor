...
//Here we register ShopOnlineDbContext class for dependency injection, its reading the connection string from
//appsettings.json
...
app.UseCors( policy => 
    policy.WithOrigins("http://localhost:7245", "https://localhost:7245")
    .AllowAnyMethod()
